...
normal.cost <- data.frame(age = seq(0,1,0.1)) |> 
...
high.cost <- data.frame(age = seq(0,1,0.1)) |> 
    mutate(gamma = gamma.function(a.exp, initial.gamma, age, front.constant),
           a = a.exp, initial = initial.gamma, constant = front.constant)
...
higher.cost <- data.frame(age = seq(0,1,0.1)) |> 
    mutate(gamma = gamma.function(a.exp, initial.gamma, age, front.constant),
           a = a.exp, initial = initial.gamma, constant = front.constant)
...
low.cost <- data.frame(age = seq(0,1,0.1)) |> 
    mutate(gamma = gamma.function(a.exp, initial.gamma, age, front.constant),
           a = a.exp, initial = initial.gamma, constant = front.constant)
...
lower.cost <- data.frame(age = seq(0,1,0.1)) |> 
    mutate(gamma = gamma.function(a.exp, initial.gamma, age, front.constant),
           a = a.exp, initial = initial.gamma, constant = front.constant)
...
normal.cost |> 
    ...
    ggtitle("Learnability parameter changing with age, increasing")+
    ylim(0, 0.07)
...
```{r gamma-plot-decreasing, echo = F}
gamma.function = function(a, b, age, constant){
    return ( constant * (-age^a) + b )
}
...
normal.cost |> 
    ...
    xlab("Proportional age")+
    ylab("Gamma parameter")+
    ggtitle("Learnability parameter changing with age, decreasing")
