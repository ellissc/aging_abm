...
lndf5 <- read_csv(here("code",
                      "Language Change vary-growth-curve-table.csv"),
                 show_col_types = F, skip = 6) |> 
    janitor::clean_names()
...
ggplot(lndf5, aes(x = step, y = mean_state_of_nodes, group = run_number,
    ...
    scale_color_brewer(name = "Grammar 1\nstarting percentage", type = "qual" ,
                       palette = 3)+
    theme_bw()+
    facet_grid(gamma_with_age~percent_grammar_1)+
    ggtitle("Growth curve type")
...
lndf6 <- read_csv(here("code",
                      "Language Change vary-growth-curve-cost-table.csv"),
                 show_col_types = F, skip = 6) |> 
    janitor::clean_names()

ggplot(lndf6, aes(x = step, y = mean_state_of_nodes, group = run_number,
                  color = factor(percent_grammar_1)))+
    geom_line(alpha = 0.5)+
    scale_color_brewer(name = "Grammar 1\nstarting percentage", type = "qual" ,
                       palette = 3)+
    ...
    ggtitle("Varied growth curve cost", subtitle = "Increasing gamma only")
...
ggplot(lndf7, aes(x = step, y = mean_state_of_nodes, group = run_number,
                  color = factor(percent_grammar_1)))+
    geom_line(alpha = 0.5)+
    scale_color_brewer(name = "Grammar 1\nstarting percentage", type = "qual" ,
                       palette = 3)+
