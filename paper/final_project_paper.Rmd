...
ggplot(gvdf, aes(x = percent_grammar_1, y = mean_state_of_nodes,
    ...
    ggtitle("Relationship between gamma and alpha (grammar 1 bias)")
...
#     ggtitle("Deterministic gamma / learning rates")+
#     xlab("Step")+
#     ylab("Mean state of nodes")
print("holder")
...
**Measure: average steps to equilibrium?**
**Emergence of dialect subgroups?**
