...
## Collective patterns of language usage change over time
...
- Propose but verify (hypothesis testing)[^3]

- Structural inference[^4]
...
<!-- Language changes over time: interactions between the individuals and collective level dynamics. As individuals age, their ability to learn may be affected by cognitive decline. -->

<!-- How do learning rates and aging impact collective-level trends in language change? -->
